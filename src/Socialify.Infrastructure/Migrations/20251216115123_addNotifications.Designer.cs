...
namespace Socialify.Infrastructure.Migrations
{
    ...
    [Migration("20251216115123_addNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.Friendship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.FriendRequest", b =>
                {
                    b.HasOne("Socialify.Domain.Entities.ApplicationUser", "Receiver")
                        .WithMany("ReceivedFriendRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Socialify.Domain.Entities.ApplicationUser", "Sender")
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.Friendship", b =>
                {
                    b.HasOne("Socialify.Domain.Entities.ApplicationUser", "Friend")
            ...
            modelBuilder.Entity("Socialify.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("Socialify.Domain.Entities.ApplicationUser", "ReceiverUser")
                        .WithMany()
